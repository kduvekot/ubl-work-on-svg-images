...
<!-- Driver that supplies the two EXPath File functions imageSummaryGrouped.xsl uses.
     Saxon-PE/EE (what xslt2pe runs) has them built in; Saxon-HE does not.
     imageSummaryGrouped.xsl itself is imported unmodified. -->
...
<xsl:import href="file:///tmp/claude-0/-home-user-ubl-work-on-svg-images/e9c78a79-2c60-5016-879a-12f876a7d9c9/scratchpad/imageSummaryGrouped.xsl"/>
